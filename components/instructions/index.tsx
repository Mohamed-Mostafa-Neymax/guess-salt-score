    ...
    return (
        <div className="flex gap-20">
            <div className="max-w-[720px] font-bold">
                <h2 className="text-4xl MontserratBold text-[#018167] text-center mb-32 invisible">Instructions</h2>
            ...
            <div>
                <h2 className="text-4xl MontserratBold text-[#018167] text-center mb-40">Instructions</h2>
                <ul className="text-[#2E4D52] text-2xl mb-32">
                    <li className="flex items-center gap-5 mb-10">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 146 153" fill="none">
                                <circle cx="73" cy="73" r="73" fill="#007559" />
                                <path d="M55.7712 58.6398L54.9297 59.8419L56.113 60.7096L71.113 71.7096L72.2951 72.5765L73.1889 71.4146L90.5 48.9102V149.5V151H92H112.5H114V149.5V4.5V3H112.5H95.5H94.719L94.2712 3.63981L55.7712 58.6398Z" fill="#1F526B" stroke="white" stroke-width="3" />
                            </svg>
                        </div>
