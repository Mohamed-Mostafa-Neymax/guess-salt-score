            ...
            <div className="text-center text-white flex flex-col justify-end items-center gap-10 h-full">
                {
                    isGuessingStage && (
                        <>
                            <p className="text-md">POINTS<br />EARNED:<br />{points}</p>
                            <div
                ...
                <button 
                    ...
                    className="bg-[#EA417A] flex flex-col gap-3 items-center justify-center text-wrap w-20 h-44 px-1 rounded-lg MontserratBold text-xs">
                ...
                </button>
                {
                    isGuessingStage && (
                        <button
                            ...
                            className="bg-[#EA417A] flex flex-col gap-3 items-center justify-center text-wrap w-20 h-44 px-1 rounded-lg MontserratBold text-xs">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="35" viewBox="0 0 80 103" fill="none">
                ...
                <button type="button" onClick={() => { setPopup(prevState => ({ isOpen: true, content: 'refs' })) }} className="bg-[#EA417A] flex flex-col gap-3 items-center justify-center text-wrap w-20 h-44 px-1 rounded-lg MontserratBold text-xs">
