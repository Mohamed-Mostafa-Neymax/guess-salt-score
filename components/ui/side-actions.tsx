...
const SideActions: React.FC<{ isGuessingStage: boolean; }> = ({ isGuessingStage }) => {
    ...
    return (
        <>
            {
                isOpenPopup && (
                    <div className="absolute w-screen h-screen bg-[#00000082] flex items-center justify-center">
                        <div className={`bg-[#F9F4F0] w-4/5 p-20 rounded-3xl relative animatePopup`}>
                            <Overview isPopup={true} onClosePopup={() => { setIsOpenPopup(false) }} />
                        </div>
                    </div>
                )
            }
            <div className="text-center text-white flex flex-col justify-end items-center gap-10 h-full">
                ...
                <button type="button" onClick={() => { router.push('/') }} className="bg-[#EA417A] flex flex-col gap-3 items-center justify-center text-wrap w-32 h-40 rounded-lg MontserratBold text-xl">
                ...
                {
                    isGuessingStage && (
                        <button type="button" onClick={() => { setIsOpenPopup(true) }} className="bg-[#EA417A] flex flex-col gap-3 items-center justify-center text-wrap w-32 h-40 rounded-lg MontserratBold text-xl">
                ...
                <button type="button" onClick={openRefsHandler} className="bg-[#EA417A] flex flex-col gap-3 items-center justify-center text-wrap w-32 h-40 rounded-lg MontserratBold text-xl">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="53" viewBox="0 0 80 83" fill="none">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M79.9996 19.9939H27.5156V17.4946H79.9996V19.9939Z" fill="white" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M79.9996 49.9846H27.5156V47.4854H79.9996V49.9846Z" fill="white" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M79.9996 79.9758H27.5156V77.4766H79.9996V79.9758Z" fill="white" />
                    </svg>
                    <span>REFS</span>
                </button>
            </div>
